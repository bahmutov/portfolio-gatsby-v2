...
<Change>
  ...
  [design/colors](https://github.com/ryanfiller/portfolio-gatsby-v2/pull/52) - Colors chart components and css changes
  ...
  - Styles 
    - globals
      ...
      \+ set theme color variables to gatsby defaults
